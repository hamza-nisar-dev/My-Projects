    ...
    if len(ref_id) > 1:
            ...
            if len(jobs) ==0:
                ...
                for row in cursor:
                    ...
                    conn.commit() 
                keyboard = [[InlineKeyboardButton("🔑 1 MONTH ACCESS VIP🔑 $39", callback_data='1')],[InlineKeyboardButton("🔑 Humans Crypto Free 🔑", url='https://t.me/humans_crypto')],[InlineKeyboardButton("Refferal", callback_data='qre')]]  
...
def button(update, context):
  ...
  if a== '50a' or a=='25a' or a=="70a" or a=='125a' or a=="200a":#or a== '48' or a=='95' or a=="120"or a=='210' or a=="360" or a== '50' or a=='100' or a=="135"or a=='240' or a=="450":
    ...
    query.answer()
    keyboard = [[InlineKeyboardButton("🔑 1 MONTH ACCESS VIP🔑 $59", callback_data='1')],[InlineKeyboardButton("🔑 Humans Crypto Free 🔑", url='https://t.me/humans_crypto')],[InlineKeyboardButton("Refferal", callback_data='qre')]]  
    reply_markup = InlineKeyboardMarkup(keyboard,resize_keyboard=True) 
    context.bot.send_message(chat_id=update.effective_user.id,text="Please Select you package:",reply_markup=reply_markup)
    return BUTTON
  elif a== 'qre':
