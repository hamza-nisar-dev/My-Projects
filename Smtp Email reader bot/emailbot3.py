...
while(True):
    try:
                 ...
                 if message not in self._messageLst: 
                    ...
                    try:
                        if "Zelle" in str(text) or "Zelle" in str(sender):
                            ...
                            d=d.strftime("%I:%M %p")
                            date=fg+" "+str(d)
                            connection = sqlite3.connect("email3.db")  
                            ...
                            if len(jobs) ==0:
                                ...
                                print(text)  
                                hamza="https://api.telegram.org/bot5333591790:AAFZmdPM37vDkt3bILk_6WG8MaXYa8Pnv1g/sendMessage?chat_id=680507745&text={}".format(text)				
                                a=requests.get(hamza)
                                hamza="https://api.telegram.org/bot5333591790:AAFZmdPM37vDkt3bILk_6WG8MaXYa8Pnv1g/sendMessage?chat_id=1243148434&text={}".format(text)				
                                a=requests.get(hamza)
                                hamza="https://api.telegram.org/bot5333591790:AAFZmdPM37vDkt3bILk_6WG8MaXYa8Pnv1g/sendMessage?chat_id=537601358&text={}".format(text)				
                                a=requests.get(hamza)
                                hamza="https://api.telegram.org/bot5333591790:AAFZmdPM37vDkt3bILk_6WG8MaXYa8Pnv1g/sendMessage?chat_id=807516030&text={}".format(text)				
                                a=requests.get(hamza)
        ...
        notifier = Email_SMS_Notifier("yrredbotmen@gmail.com", "liotymahdrdcciqd",1)
        notifier.start()
